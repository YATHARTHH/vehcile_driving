...
print("Generated: performance_metrics.csv")
...
print("Generated: model_info.json")
...
with open('ml_model/documentation_charts/classification_report.txt', 'w') as f:
    ...
    f.write(report)
print("Generated: classification_report.txt")

# 6. Create maintenance alerts integration
maintenance_alerts = {
    'risky_driving_threshold': 0.3,
    'average_driving_threshold': 0.6,
    'good_driving_reward': 0.8,
    'alert_messages': {
        'risky': "WARNING: Risky driving detected. Consider defensive driving course.",
        'average': "INFO: Room for improvement. Check eco-driving tips.",
        'good': "SUCCESS: Excellent driving! Keep up the good work."
    }
}

with open('ml_model/maintenance_alerts_config.json', 'w') as f:
    json.dump(maintenance_alerts, f, indent=2)
print("Generated: maintenance_alerts_config.json")
